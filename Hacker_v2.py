...
ITEM_MAPPING = {"100933":"熊胆","100934":"熊掌", "110001":"逍遥散","110002":"再造膏","110003":"承气散","110004":"黑玉断续膏","110005":"天香断续胶",
...
"110056":"桂圆红枣鸡汤","110057":"包叶智慧果","130015":"智慧果","130034":"回锅肉","130064":"质地漂亮的石头", "130068":"大红袍","130069":"半山妖",
...
"130051":"稀有矿石", "130053":"蟾蜍", "130057":"蜈蚣", "130054":"蝎子", "130055":"毒蛇", "130056":"蜘蛛"}

WEAPON_MAPPING = {'100001':'逍遥刀剑', '100002':'太乙刀剑','100003':'无极刀剑','100004':'阴阳倒乱刃','100005':'紫金双刃','100101':'粗布拳套','100102':'皮手套','100103':'鹿革手套','100104':'离魂金线缠',
...
def main():
    ...
    print("****************************************************************************************************************")
    input("请确保游戏已关闭，回车继续")
    root = input("请输入游戏存档目录(steam用户目录在Steam\\userdata\\xxxxxxxxx\\xxxxxx\\remote，普通用户目录在Tale of Wuxia: Prequel\\Config\\SaveData):\n")
    ...
    while(True):
        ...
        if user_input == "3":
            while(True):
                print("当前拥有以下物品(物品名不完全)：")
                items = data["m_BackpackList"]
                items.sort(key=lambda item: item["m_ItemID"])
                item_list = []
                for item in items:
                ...
                user_selection = input("选择操作（0-返回，1-查看物品编号，2-一键添加药品，3-一键添加原材料, 4-一键添加所有武学，5-手动添改): ")
                if user_selection == "":
                    continue
                if user_selection == "0":
                    break
